...
+
See  <<dsconfig-create-key-manager-provider-file-based-key-manager-provider>> for the properties of this Key Manager Provider type.
...
Enabled by default: true
+
See  <<dsconfig-create-key-manager-provider-ldap-key-manager-provider>> for the properties of this Key Manager Provider type.
...
Enabled by default: true
+
See  <<dsconfig-create-key-manager-provider-pkcs11-key-manager-provider>> for the properties of this Key Manager Provider type.
====
...
[#dsconfig-create-key-manager-provider-ldap-key-manager-provider]
== LDAP Key Manager Provider
