...
[#log-ref-log-ref-ERR_BASE_DN_ALREADY]
ID: N/A::

Severity: ERROR
+
Message: The base DN '%s' is already defined.

[#log-ref-log-ref-ERR_BASE_DN_ANCESTOR]
ID: N/A::

Severity: ERROR
+
Message: The backend already contains another base DN that is within the same hierarchical path (%s is an ancestor of the provided base DN).

[#log-ref-log-ref-ERR_BASE_DN_DN_IS_ANCESTOR]
ID: N/A::

Severity: ERROR
+
Message: The backend already contains another base DN that is within the same hierarchical path (%s is a descendant of the provided base DN).

[#log-ref-log-ref-ERR_CANNOT_CONNECT_TO_LOGIN_WITH]
ID: N/A::

Severity: ERROR
+
Message: Could not connect to the Directory Server with the provided credentials.  The possible causes for this are:%n%s.

[#log-ref-log-ref-ERR_CANNOT_MODIFY_OBJECTCLASS_AND]
ID: N/A::

Severity: ERROR
+
Message: Cannot modify the objectclass and rename the entry.

[#log-ref-log-ref-ERR_CLI_UNINSTALL_NOTHING_TO_BE]
ID: N/A::

Severity: ERROR
+
Message: You must select something to be uninstalled.

[#log-ref-log-ref-ERR_CLI_UNINSTALL_NOTHING_TO_BE_UNINSTALLED_NON]
ID: N/A::

Severity: ERROR
+
Message: You must select the elements to uninstall.  Use the options described in the usage to specify what must be uninstalled.

[#log-ref-log-ref-ERR_CONTROL_PANEL_LAUNCHER_GUI_LAUNCH]
ID: N/A::

Severity: ERROR
+
Message: Could not launch Control Panel.  Check that you have access to the display.

[#log-ref-log-ref-ERR_CONTROL_PANEL_LAUNCHER_GUI_LAUNCH_FAILED]
ID: N/A::

Severity: ERROR
+
Message: Could not launch Control Panel.  Check that you have access to the display.   Check file %s for details.

[#log-ref-log-ref-ERR_COULD_NOT_FIND_VALID]
ID: N/A::

Severity: ERROR
+
Message: Error reading the configuration file.%nThis could be caused because there is not an enabled LDAP port for the specified connection parameters or because you do not have read rights on the configuration file.

[#log-ref-log-ref-ERR_CTRL_PANEL_ADDING_TO_GROUP_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred adding to groups.

[#log-ref-log-ref-ERR_CTRL_PANEL_ALIAS_ALREADY_IN]
ID: N/A::

Severity: ERROR
+
Message: The provided alias '%s' already exists in the schema (defined as %s).

[#log-ref-log-ref-ERR_CTRL_PANEL_ATTRIBUTE]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for attribute %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ATTRIBUTE_CANNOT_BE_ITS]
ID: N/A::

Severity: ERROR
+
Message: An attribute cannot be its own superior.

[#log-ref-log-ref-ERR_CTRL_PANEL_ATTRIBUTE_IS_SUPERIOR_OF]
ID: N/A::

Severity: ERROR
+
Message: The attribute is superior (directly or indirectly) of '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_ATTRIBUTE_NAME]
ID: N/A::

Severity: ERROR
+
Message: You must provide a name for the attribute.

[#log-ref-log-ref-ERR_CTRL_PANEL_ATTRIBUTE_NAME_ALREADY_IN]
ID: N/A::

Severity: ERROR
+
Message: The provided name '%s' already exists in the schema (defined as %s).

[#log-ref-log-ref-ERR_CTRL_PANEL_BACKEND_NOT_FOUND]
ID: N/A::

Severity: ERROR
+
Message: The backend '%s' could not be found.  Check main panel for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_BACKUP_ID_ALREADY]
ID: N/A::

Severity: ERROR
+
Message: A backup with ID '%s' is already defined under '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_BACKUP_PATH]
ID: N/A::

Severity: ERROR
+
Message: The file '%s' exists.  You must provide a directory to do the new backup.

[#log-ref-log-ref-ERR_CTRL_PANEL_BACKUP_PATH_DOES_NOT]
ID: N/A::

Severity: ERROR
+
Message: The backup path '%s' does not exist.

[#log-ref-log-ref-ERR_CTRL_PANEL_BACKUP_PATH_IS_A]
ID: N/A::

Severity: ERROR
+
Message: The backup path '%s" exists and is a file.

[#log-ref-log-ref-ERR_CTRL_PANEL_CANCELING_TASK_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred canceling the selected tasks.

[#log-ref-log-ref-ERR_CTRL_PANEL_CANNOT_READ]
ID: N/A::

Severity: ERROR
+
Message: Cannot read file '%s'.  Check that you have read rights to it.

[#log-ref-log-ref-ERR_CTRL_PANEL_COULD_NOT_FIND_PROVIDED_ENTRY_IN]
ID: N/A::

Severity: ERROR
+
Message: Could not find entry specified in '%s'.  Check that the entry exists in server %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_COULD_NOT_FIND_PROVIDED_ENTRY_IN_REFERRAL_NO]
ID: N/A::

Severity: ERROR
+
Message: Could not find entry specified in '%s'.  Check that the entry exists in server.

[#log-ref-log-ref-ERR_CTRL_PANEL_CREATING_ATTRIBUTE_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred creating attribute '%s'.  Check details for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_CREATING_BASE_DN_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred during the creation of the base DN.  Error code: %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_CREATING_NEW_ENTRY_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error creating new entry.

[#log-ref-log-ref-ERR_CTRL_PANEL_CREATING_NEW_INDEX_ERROR]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_CREATING_NEW_VLV_INDEX_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error creating VLV index.

[#log-ref-log-ref-ERR_CTRL_PANEL_CREATING_OBJECTCLASS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred creating object class '%s'.  Check details for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_DATE_ALREADY]
ID: N/A::

Severity: ERROR
+
Message: The provided date already passed.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_ATTRIBUTE_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting attribute '%s'.  Check details for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_BACKENDS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting backends.  Check details for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_BASE_DNS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error deleting base DNs.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_ENTRIES_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting entries.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_ENTRY_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting entry '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_INDEXES_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting indexes '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_INDEX_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting index '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_OBJECTCLASS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred deleting object class '%s'.  Check details for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_SCHEMA_ELEMENTS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error deleting schema elements.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_SUBTREE_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error deleting subtree.

[#log-ref-log-ref-ERR_CTRL_PANEL_DELETING_VLV_INDEX_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error deleting VLV index.

[#log-ref-log-ref-ERR_CTRL_PANEL_DISABLING_WINDOWS_SERVICE_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred during the disabling of the Windows service.  Error code: %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_DN_NOT]
ID: N/A::

Severity: ERROR
+
Message: The DN is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_DN_NOT_VALID_WITH]
ID: N/A::

Severity: ERROR
+
Message: Invalid dn value: '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_DUPLICATE_ENTRY_NAME]
ID: N/A::

Severity: ERROR
+
Message: You must provide the name of the new entry.

[#log-ref-log-ref-ERR_CTRL_PANEL_DUPLICATE_ENTRY_PARENT_DN_NOT]
ID: N/A::

Severity: ERROR
+
Message: You must provide a valid DN for the parent entry.

[#log-ref-log-ref-ERR_CTRL_PANEL_DUPLICATE_ENTRY_PARENT_DOES_NOT]
ID: N/A::

Severity: ERROR
+
Message: The parent entry does not exist.

[#log-ref-log-ref-ERR_CTRL_PANEL_EMPTY]
ID: N/A::

Severity: ERROR
+
Message: You have provided an empty alias.

[#log-ref-log-ref-ERR_CTRL_PANEL_ENABLING_WINDOWS_SERVICE_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error during Enabling of Windows Service.

[#log-ref-log-ref-ERR_CTRL_PANEL_ENTRY_ALREADY]
ID: N/A::

Severity: ERROR
+
Message: Entry '%s' already exists.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_CHECKING]
ID: N/A::

Severity: ERROR
+
Message: Error checking entry.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_CHECKING_JAVA_SETTINGS]
ID: N/A::

Severity: ERROR
+
Message: An unexpected error occurred checking the provided Java settings.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_CREATING_NEW_DATA]
ID: N/A::

Severity: ERROR
+
Message: Could not created local LDIF to populate new base DN with automatically generated data. Error details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_DECODING]
ID: N/A::

Severity: ERROR
+
Message: An error occurred decoding the provided base 64 string.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_READING]
ID: N/A::

Severity: ERROR
+
Message: An error occurred reading the contents of the file.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_READING_CONFIGURATION]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_SEARCHING]
ID: N/A::

Severity: ERROR
+
Message: An error occurred searching entry '%s'.  Details:&lt;br>%s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERROR_UPDATING]
ID: N/A::

Severity: ERROR
+
Message: Error updating schema.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_ERR_READING_JAVA_SETTINGS]
ID: N/A::

Severity: ERROR
+
Message: Error reading Java settings.

[#log-ref-log-ref-ERR_CTRL_PANEL_EXPORTING_LDIF_ERROR]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_EXPORT_DIRECTORY]
ID: N/A::

Severity: ERROR
+
Message: The provided path '%s' exists and it is a directory.

[#log-ref-log-ref-ERR_CTRL_PANEL_FILE_DOES_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_FILE_NOT]
ID: N/A::

Severity: ERROR
+
Message: You have to provide a value for the file.

[#log-ref-log-ref-ERR_CTRL_PANEL_GENERIC_ERROR_FALLBACK]
ID: N/A::

Severity: ERROR
+
Message: The Java home value '%s' is not valid.  This value will be used as fall back when the OPENDJ_JAVA_HOME environment variable is not defined.  If you do not want to specify a fall back, leave the Java Home text field empty or specify a valid Java home.&lt;br>Error details:&lt;br>%s.

[#log-ref-log-ref-ERR_CTRL_PANEL_GROUP_COULD_NOT_BE]
ID: N/A::

Severity: ERROR
+
Message: The group '%s' could not be found.

[#log-ref-log-ref-ERR_CTRL_PANEL_GROUP_FILTER]
ID: N/A::

Severity: ERROR
+
Message: You must provide an LDAP URL with a filter for the group.

[#log-ref-log-ref-ERR_CTRL_PANEL_GROUP_FILTER_NOT]
ID: N/A::

Severity: ERROR
+
Message: The provided LDAP URL value is not valid.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_GROUP_NOT]
ID: N/A::

Severity: ERROR
+
Message: You must specify a group.

[#log-ref-log-ref-ERR_CTRL_PANEL_IMPORTING_LDIF_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred during the import.  Error code: %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_INCOMPATIBLE_SUPERIORS_WITH]
ID: N/A::

Severity: ERROR
+
Message: You are editing a structural object class.  The following object classes are auxiliary: %s.%nOnly structural or abstract object classes can be used as superior object classes of a structural object class.

[#log-ref-log-ref-ERR_CTRL_PANEL_INDEX_MUST_BE]
ID: N/A::

Severity: ERROR
+
Message: You must select an index.

[#log-ref-log-ref-ERR_CTRL_PANEL_INDEX_TO_BE_VERIFIED]
ID: N/A::

Severity: ERROR
+
Message: You must select at least one index to be verified.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID]
ID: N/A::

Severity: ERROR
+
Message: The provided time value is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_ATTRIBUTE]
ID: N/A::

Severity: ERROR
+
Message: The provided name is not valid.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_BASE_DN]
ID: N/A::

Severity: ERROR
+
Message: The provided base DN is not valid.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_BASE_DN_FOR_VLV]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_DAY_IN]
ID: N/A::

Severity: ERROR
+
Message: The day '%d' does not exist in %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_ENTRY_LIMIT]
ID: N/A::

Severity: ERROR
+
Message: The entry limit must be an integer between %d and %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_FILTER_DETAILS_WITH]
ID: N/A::

Severity: ERROR
+
Message: The provided value '%s' is not a valid filter.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_FILTER_FOR_VLV]
ID: N/A::

Severity: ERROR
+
Message: The provided filter is not valid.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_OBJECTCLASS]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_INVALID_WRAP]
ID: N/A::

Severity: ERROR
+
Message: The value of the wrap column must be between %d and %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_JAVA_BINARY_NOT]
ID: N/A::

Severity: ERROR
+
Message: Could not find binary '%s'.  You must specify the path to the Java installation to be used.

[#log-ref-log-ref-ERR_CTRL_PANEL_JAVA_PATH_DOES_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_JAVA_PATH_NOT_A]
ID: N/A::

Severity: ERROR
+
Message: Path '%s' is not a directory.  You must specify the path to the Java installation to be used.

[#log-ref-log-ref-ERR_CTRL_PANEL_LAUNCH_LATER_REQUIRES_SERVER]
ID: N/A::

Severity: ERROR
+
Message: To be able to launch tasks on a future date, the server must be running.

[#log-ref-log-ref-ERR_CTRL_PANEL_LAUNCH_SCHEDULE_REQUIRES_SERVER]
ID: N/A::

Severity: ERROR
+
Message: To be able to launch tasks periodically, the server must be running.

[#log-ref-log-ref-ERR_CTRL_PANEL_MEMBER]
ID: N/A::

Severity: ERROR
+
Message: You must provide a member for the group.

[#log-ref-log-ref-ERR_CTRL_PANEL_MEMBER_NOT]
ID: N/A::

Severity: ERROR
+
Message: The entry '%s' could not be found.

[#log-ref-log-ref-ERR_CTRL_PANEL_MEMBER_VALUE_NOT]
ID: N/A::

Severity: ERROR
+
Message: The provided value as member '%s' is not valid.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_MODIFYING_ATTRIBUTE_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error modifying attribute.

[#log-ref-log-ref-ERR_CTRL_PANEL_MODIFYING_ENTRY_ERROR]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_MODIFYING_INDEX_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred modifying index '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_MODIFYING_OBJECTCLASS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error modifying object class.

[#log-ref-log-ref-ERR_CTRL_PANEL_MODIFYING_VLV_INDEX_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error modifying VLV index.

[#log-ref-log-ref-ERR_CTRL_PANEL_MUST_SELECT_BASE]
ID: N/A::

Severity: ERROR
+
Message: You must select a base DN.

[#log-ref-log-ref-ERR_CTRL_PANEL_MUST_SELECT_INDEX_TO]
ID: N/A::

Severity: ERROR
+
Message: You must select at least one index to be rebuilt.

[#log-ref-log-ref-ERR_CTRL_PANEL_NAME_OF_DOMAIN]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the name of the domain.

[#log-ref-log-ref-ERR_CTRL_PANEL_NAME_OF_GROUP]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the name of the group.

[#log-ref-log-ref-ERR_CTRL_PANEL_NAME_OF_ORGANIZATION]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the name of the organization.

[#log-ref-log-ref-ERR_CTRL_PANEL_NAME_OF_OU]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the Name of the Organizational Unit.

[#log-ref-log-ref-ERR_CTRL_PANEL_NEW_PASSWORD]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the new password.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_A_DESCENDANT_OF_BASE]
ID: N/A::

Severity: ERROR
+
Message: The base DN '%s' is not a descendant of any of the base DNs defined in backend '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_A_STATIC]
ID: N/A::

Severity: ERROR
+
Message: The entry '%s' exists but it is not an static group.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_VALID_ATTRIBUTE]
ID: N/A::

Severity: ERROR
+
Message: The attribute '%s' has not a valid name.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_VALID_CRON_HOUR]
ID: N/A::

Severity: ERROR
+
Message: The hour value provided is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_VALID_CRON_MINUTE]
ID: N/A::

Severity: ERROR
+
Message: The minute value provided is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_VALID_CRON_MONTH]
ID: N/A::

Severity: ERROR
+
Message: The month value provided is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_VALID_CRON_MONTH_DAY]
ID: N/A::

Severity: ERROR
+
Message: The day of month value provided is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_VALID_CRON_WEEK_DAY]
ID: N/A::

Severity: ERROR
+
Message: The day of week value provided is not valid.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_WORKING_FALLBACK_JVM]
ID: N/A::

Severity: ERROR
+
Message: The Java binary '%s' could not be used to launch the server scripts.  This value will be used as fall back when the OPENDJ_JAVA_HOME environment variable is not defined.  If you do not want to specify a fall back, leave the Java Home text field empty or specify a valid Java home.

[#log-ref-log-ref-ERR_CTRL_PANEL_NOT_WORKING_JVM]
ID: N/A::

Severity: ERROR
+
Message: The Java binary '%s' could not be used to launch the server scripts.&lt;br>The server cannot run using the provided Java Home.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_ATTRIBUTE_FOR_VLV]
ID: N/A::

Severity: ERROR
+
Message: You must select at least one attribute for the sort order.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BACKEND]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BACKENDS]
ID: N/A::

Severity: ERROR
+
Message: No backends selected.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BACKENDS_FOUND]
ID: N/A::

Severity: ERROR
+
Message: There are no backends defined.  To create and manage indexes, you must create a backend.  To create a new backend you can use the action "New Base DN".

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BACKUP_ID]
ID: N/A::

Severity: ERROR
+
Message: No backup ID provided.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BACKUP_PATH]
ID: N/A::

Severity: ERROR
+
Message: No backup path provided.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BASE_DN]
ID: N/A::

Severity: ERROR
+
Message: You must provide a base DN.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BASE_DNS_DEFINED]
ID: N/A::

Severity: ERROR
+
Message: No base DNs defined.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_BASE_DN_FOR_VLV]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_NO_CRON_HOUR]
ID: N/A::

Severity: ERROR
+
Message: No hour provided.  Use '*' to indicate any value.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_CRON_MINUTE]
ID: N/A::

Severity: ERROR
+
Message: No minute provided.  Use '*' to indicate any value.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_CRON_MONTH]
ID: N/A::

Severity: ERROR
+
Message: No month provided.  Use '*' to indicate any value.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_CRON_MONTH_DAY]
ID: N/A::

Severity: ERROR
+
Message: No day of month provided.  Use '*' to indicate any value.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_CRON_WEEK_DAY]
ID: N/A::

Severity: ERROR
+
Message: No day of week provided.  Use '*' to indicate any value.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_FILTER_FOR_VLV]
ID: N/A::

Severity: ERROR
+
Message: You must provide a filter for the index.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_INDEX]
ID: N/A::

Severity: ERROR
+
Message: No index selected on the tree.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_INDEXES_FOR]
ID: N/A::

Severity: ERROR
+
Message: No indexes defined for base DN '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_INDEX_TYPE]
ID: N/A::

Severity: ERROR
+
Message: You must select at least one index type (approximate, equality, ordering, presence or substring).

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_MONTH_DAY]
ID: N/A::

Severity: ERROR
+
Message: You must select at least one day of the month.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_PARENT_BACKUP]
ID: N/A::

Severity: ERROR
+
Message: You have chosen to run an incremental backup.  You must select the parent backup in the list of available parent backups.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_PARENT_BACKUP_ID]
ID: N/A::

Severity: ERROR
+
Message: No parent backup ID provided.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_PARENT_BACKUP_TO]
ID: N/A::

Severity: ERROR
+
Message: You must provide the parent directory containing the backup files.  Then click on 'Refresh' to update the list of available backups.&lt;br>Finally select a backup from the list.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_VLV_INDEX_NAME]
ID: N/A::

Severity: ERROR
+
Message: No VLV index name provided.

[#log-ref-log-ref-ERR_CTRL_PANEL_NO_WEEK_DAY]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_OBJECTCLASS_CANNOT_BE_ITS]
ID: N/A::

Severity: ERROR
+
Message: An object class cannot be its own superior.

[#log-ref-log-ref-ERR_CTRL_PANEL_OBJECTCLASS_IS_SUPERIOR_OF]
ID: N/A::

Severity: ERROR
+
Message: The object class is superior (directly or indirectly) of '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_OBJECTCLASS_NAME]
ID: N/A::

Severity: ERROR
+
Message: You must provide a name for the object class.

[#log-ref-log-ref-ERR_CTRL_PANEL_OBJECTCLASS_NAME_ALREADY_IN]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_OID_ALREADY_IN]
ID: N/A::

Severity: ERROR
+
Message: The provided OID '%s' already exists in the schema (defined as %s).

[#log-ref-log-ref-ERR_CTRL_PANEL_OID_NOT]
ID: N/A::

Severity: ERROR
+
Message: The provided OID is not valid.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_PASSWORD_DO_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_PATH_IS_A]
ID: N/A::

Severity: ERROR
+
Message: The path '%s' is a directory.  You must provide a file.

[#log-ref-log-ref-ERR_CTRL_PANEL_READING_JAVA_SETTINGS]
ID: N/A::

Severity: ERROR
+
Message: An unexpected error occurred reading the Java settings.  Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_REBUILDING_INDEXES_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error Rebuilding Indexes.

[#log-ref-log-ref-ERR_CTRL_PANEL_REFERENCE_GROUP_NOT]
ID: N/A::

Severity: ERROR
+
Message: The provided Reference Group could not be found.

[#log-ref-log-ref-ERR_CTRL_PANEL_REFERRAL]
ID: N/A::

Severity: ERROR
+
Message: The selected referral is defined in server %s and is referencing to an entry in the same server that is an ascentor of the entry.  This configuration generates a loop in the DIT structure that should be avoided.

[#log-ref-log-ref-ERR_CTRL_PANEL_REJECTS_AND_SKIPS_MUST_BE]
ID: N/A::

Severity: ERROR
+
Message: The rejects and skips file must have different values.

[#log-ref-log-ref-ERR_CTRL_PANEL_REJECTS_FILE]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the rejects file.

[#log-ref-log-ref-ERR_CTRL_PANEL_REQUIRED_BACKUP_TO]
ID: N/A::

Severity: ERROR
+
Message: You must select a backup from the list of available backups.

[#log-ref-log-ref-ERR_CTRL_PANEL_RESETTING_USER_PASSWORD_ERROR]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_RESOLVING_REFERRAL]
ID: N/A::

Severity: ERROR
+
Message: The error occurred solving referral '%s'.&lt;br>Details: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_RESTARTING_SERVER_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred restarting the server.  Error code: %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_RESTORING_ERROR]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_RUN_BACKUP_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred during the backup.  Error code: %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_SCHEMA_NOT_FOUND]
ID: N/A::

Severity: ERROR
+
Message: The schema could not be found.  Check main panel for more information.

[#log-ref-log-ref-ERR_CTRL_PANEL_SETTING]
ID: N/A::

Severity: ERROR
+
Message: Error setting environment: %s.

[#log-ref-log-ref-ERR_CTRL_PANEL_SKIPS_FILE]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the skips file.

[#log-ref-log-ref-ERR_CTRL_PANEL_STARTING_SERVER_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error during server start.

[#log-ref-log-ref-ERR_CTRL_PANEL_STOPPING_SERVER_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error during Server Stop.

[#log-ref-log-ref-ERR_CTRL_PANEL_STOPPING_SERVER_POST_CMD]
ID: N/A::

Severity: ERROR
+
Message: The command-line %s returned successfully but the server appears to be running.

[#log-ref-log-ref-ERR_CTRL_PANEL_UNEXPECTED]
ID: N/A::
...
[#log-ref-log-ref-ERR_CTRL_PANEL_UPDATING_JAVA_SETTINGS_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred updating Java settings.

[#log-ref-log-ref-ERR_CTRL_PANEL_USER_COMMON_NAME]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for 'Common Name'.

[#log-ref-log-ref-ERR_CTRL_PANEL_USER_LAST_NAME]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for 'Last Name'.

[#log-ref-log-ref-ERR_CTRL_PANEL_USER_NAMING_ATTRIBUTE]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the naming attribute '%s'.

[#log-ref-log-ref-ERR_CTRL_PANEL_VALUE_IN_BASE_64]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value in Base 64 format.

[#log-ref-log-ref-ERR_CTRL_PANEL_VERIFYING_BACKUP_ERROR]
ID: N/A::

Severity: ERROR
+
Message: An error occurred during the backup verification.  Error code: %d.

[#log-ref-log-ref-ERR_CTRL_PANEL_VERIFYING_INDEXES_ERROR]
ID: N/A::

Severity: ERROR
+
Message: Error during Index Verification.

[#log-ref-log-ref-ERR_CTRL_PANEL_VLV_INDEX_ALREADY]
ID: N/A::

Severity: ERROR
+
Message: There is already a VLV index '%s' defined in backend '%s'.

[#log-ref-log-ref-ERR_DEPENDENCY_TASK_NOT]
ID: N/A::

Severity: ERROR
+
Message: There is no task with ID '%s' in the server.

[#log-ref-log-ref-ERR_ERROR_CONNECTING_TO_SERVER_PROMPT]
ID: N/A::

Severity: ERROR
+
Message: Could not connect to the Directory Server %s with the provided credentials.%nError details: %s%n%nProvide again the required information to connect to the server:.

[#log-ref-log-ref-ERR_ERROR_SEARCHING_BACKUPS]
ID: N/A::

Severity: ERROR
+
Message: Error searching backups.

[#log-ref-log-ref-ERR_IMPORT_THREAD_NUMBER]
ID: N/A::

Severity: ERROR
+
Message: The thread number must be a positive integer.

[#log-ref-log-ref-ERR_INCOMPATIBLE_VERSION_IN_REMOTE]
ID: N/A::

Severity: ERROR
+
Message: The remote server in '%s' has not the same version as the control panel.  The remote server version is '%s.%s.%s' and the control panel version is '%d.%d.%d'.

[#log-ref-log-ref-ERR_INFO_CTRL_ATTRIBUTE_NAME]
ID: N/A::

Severity: ERROR
+
Message: No attribute name selected.

[#log-ref-log-ref-ERR_INFO_CTRL_PANEL_ENTRY_LIMIT_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_INFO_ONE_INDEX_TYPE_MUST_BE]
ID: N/A::
...
[#log-ref-log-ref-ERR_INITIALIZING_REPLICATIONID_NOT]
ID: N/A::

Severity: ERROR
+
Message: Error initializing.  Could not find replication ID in the server %s for base DN %s.

[#log-ref-log-ref-ERR_INVALID_EMAIL]
ID: N/A::

Severity: ERROR
+
Message: The value '%s' is not a valid email address.

[#log-ref-log-ref-ERR_LAUNCHING_POST_EXTERNAL]
ID: N/A::

Severity: ERROR
+
Message: Error launching the operation.

[#log-ref-log-ref-ERR_LAUNCHING_PRE_EXTERNAL]
ID: N/A::
...
[#log-ref-log-ref-ERR_LAUNCHING_PURGE]
ID: N/A::
...
[#log-ref-log-ref-ERR_LDIF_REPRESENTATION]
ID: N/A::

Severity: ERROR
+
Message: You must provide the LDIF representation of the entry.

[#log-ref-log-ref-ERR_LOADING]
ID: N/A::
...
[#log-ref-log-ref-ERR_NEW_BACKEND_NAME]
ID: N/A::

Severity: ERROR
+
Message: You must provide a name for the new backend.

[#log-ref-log-ref-ERR_NEW_BASE_DN_VALUE]
ID: N/A::

Severity: ERROR
+
Message: You must provide a value for the base DN.

[#log-ref-log-ref-ERR_NON_MODIFIABLE_CANNOT_BE_USER]
ID: N/A::

Severity: ERROR
+
Message: Non Modifiable attributes must have an operational usage.

[#log-ref-log-ref-ERR_NOT_ADMINISTRATIVE]
ID: N/A::

Severity: ERROR
+
Message: You do not have access rights to the configuration of the server.

[#log-ref-log-ref-ERR_NOT_SAME_PRODUCT_IN_REMOTE_SERVER_NOT]
ID: N/A::

Severity: ERROR
+
Message: The remote server in '%s' cannot be managed by this control panel.  The remote server product name is '%s' and the control panel product name is '%s'.

[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_DISABLE]
ID: N/A::

Severity: ERROR
+
Message: There are no base DNs replicated in the server.

[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_ENABLE]
ID: N/A::

Severity: ERROR
+
Message: There are no base DNs available to enable replication between the two servers.

[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_ENABLE_REPLICATION_NO]
ID: N/A::

Severity: ERROR
+
Message: There are no base DNs available to enable replication between the two servers.  You must specify at least one server that will contain the replicated data, before configuring servers that will only contain the replication changelog (replication servers).

[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_INITIALIZE]
ID: N/A::

Severity: ERROR
+
Message: There are no Base DNs replicated between the two servers.

[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_INITIALIZE_ALL]
ID: N/A::

Severity: ERROR
+
Message: There are no base DNs replicated in the server.  The base DNs must be replicated to be able to use their contents to initialize the base DNs on the other servers.

[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_INITIALIZE_LOCAL]
ID: N/A::
...
[#log-ref-log-ref-ERR_NO_SUFFIXES_AVAILABLE_TO_PURGE]
ID: N/A::

Severity: ERROR
+
Message: There are no base DNs available to purge historical.

[#log-ref-log-ref-ERR_NO_SUFFIXES_SELECTED_TO]
ID: N/A::

Severity: ERROR
+
Message: You must choose at least one Base DN to be replicated.

[#log-ref-log-ref-ERR_NO_SUFFIXES_SELECTED_TO_INITIALIZE]
ID: N/A::

Severity: ERROR
+
Message: You must choose at least one base DN to initialize.

[#log-ref-log-ref-ERR_NO_SUFFIXES_SELECTED_TO_POST_EXTERNAL]
ID: N/A::

Severity: ERROR
+
Message: You must specify the base DNs that have been initialized using the import-ldif command or the binary copy.

[#log-ref-log-ref-ERR_NO_SUFFIXES_SELECTED_TO_PRE_EXTERNAL]
ID: N/A::

Severity: ERROR
+
Message: You must specify the base DNs that will be initialized using the import-ldif command or the binary copy.

[#log-ref-log-ref-ERR_NO_SUFFIXES_SELECTED_TO_PURGE]
ID: N/A::

Severity: ERROR
+
Message: You must choose at least one base DN to be purged from historical.

[#log-ref-log-ref-ERR_NUMBER_OF_ENTRIES]
ID: N/A::

Severity: ERROR
+
Message: The number of user entries to generate must be between %d and %d.

[#log-ref-log-ref-ERR_OBJECTCLASS_FOR_ENTRY]
ID: N/A::

Severity: ERROR
+
Message: You must provide the objectclass values of the entry.

[#log-ref-log-ref-ERR_READING_CONFIG]
ID: N/A::

Severity: ERROR
+
Message: Error reading data from server.  Verify the authentication information provided.%nDetails: %s.

[#log-ref-log-ref-ERR_READING_SCHEMA]
ID: N/A::

Severity: ERROR
+
Message: Error reading schema from the remote server.%nDetails: %s.

[#log-ref-log-ref-ERR_READING_SERVER_TASK]
ID: N/A::

Severity: ERROR
+
Message: Error reading the progress of the operation.

[#log-ref-log-ref-ERR_REFERRAL_LIMIT]
ID: N/A::

Severity: ERROR
+
Message: Referral limit (%d) reached.

[#log-ref-log-ref-ERR_REPLICATION_CANNOT_MERGE_WITH]
ID: N/A::

Severity: ERROR
+
Message: The errors reading the registry information on %s do not allow to do the merge between the replication topologies.  You will have to fix the following problems before merging the topologies:%n%s.

[#log-ref-log-ref-ERR_REPLICATION_CANNOT_WRITE_EQUIVALENT_COMMAND_LINE]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_CONFIGURING]
ID: N/A::

Severity: ERROR
+
Message: Error configuring replication port on server %s.

[#log-ref-log-ref-ERR_REPLICATION_DISABLE_SUFFIXES_NOT]
ID: N/A::

Severity: ERROR
+
Message: The following base DNs could not be found in the server:%n%s.

[#log-ref-log-ref-ERR_REPLICATION_DISABLING]
ID: N/A::

Severity: ERROR
+
Message: Error disabling replication port on server %s.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_COMMON_DOMAIN]
ID: N/A::

Severity: ERROR
+
Message: The following servers in the two topologies have the same domain ID%n%s%n%nThe replication topologies cannot be merged.  To fix this problem please refer to the documentation.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_COMMON_DOMAIN_ID]
ID: N/A::

Severity: ERROR
+
Message: Server %s (base DN '%s') and server %s (base DN '%s') have the same domain ID: %d.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_COMMON_REPLICATION_SERVER]
ID: N/A::

Severity: ERROR
+
Message: The following servers in the two topologies have the same replication server ID%n%s%n%nThe replication topologies cannot be merged.  To fix this problem please refer to the documentation.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_COMMON_REPLICATION_SERVER_ID]
ID: N/A::

Severity: ERROR
+
Message: Server %s and server %s have the same replication server ID: %d.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_SAME_SERVER]
ID: N/A::

Severity: ERROR
+
Message: You have to provide two different servers to enable replication.  You have provided twice the server %s:%s.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_SEEDING]
ID: N/A::

Severity: ERROR
+
Message: An unexpected error occurred seeding the truststore contents of server %s with truststore of server %s.  Details: %s.

[#log-ref-log-ref-ERR_REPLICATION_ENABLE_SUFFIXES_NOT]
ID: N/A::

Severity: ERROR
+
Message: The following base DNs cannot be replicated between the two servers because they could not be found in at least one of the servers:%n%s.

[#log-ref-log-ref-ERR_REPLICATION_EQUIVALENT_COMMAND_LINE_FILE]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_ERROR_READING]
ID: N/A::

Severity: ERROR
+
Message: Error reading replication configuration of server %s.%nDetails: %s.

[#log-ref-log-ref-ERR_REPLICATION_ERROR_WRITING_EQUIVALENT_COMMAND]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_INITIALIZE_LOCAL_SUFFIXES_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_INITIALIZING_TRIES]
ID: N/A::

Severity: ERROR
+
Message: Error initializing.  Could not find a peer to start the initialization after several tries.  Details: %s.

[#log-ref-log-ref-ERR_REPLICATION_NO]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_NOT_A_USER]
ID: N/A::

Severity: ERROR
+
Message: The administrative base DN '%s' cannot be replicated. Please provide a base DN that contains user data.

[#log-ref-log-ref-ERR_REPLICATION_NOT_A_VALID]
ID: N/A::

Severity: ERROR
+
Message: The provided value %s is not a valid base DN.

[#log-ref-log-ref-ERR_REPLICATION_NO_ADMINISTRATOR_PASSWORD]
ID: N/A::

Severity: ERROR
+
Message: You must provide the password of the global administrator in non interactive mode.  You can provide it using the %s or the %s options.

[#log-ref-log-ref-ERR_REPLICATION_NO_BASE_DN]
ID: N/A::

Severity: ERROR
+
Message: You must provide at least one Base DN in non interactive mode.

[#log-ref-log-ref-ERR_REPLICATION_NO_REPLICATION]
ID: N/A::

Severity: ERROR
+
Message: No replication server is defined for the following base DNs:%n%s%nAt least one replication server (a changelog) is required in the replication topology.  It is recommended to have at least two replication servers (two changelogs) to avoid a single point of failure in the replication topology.

[#log-ref-log-ref-ERR_REPLICATION_PORT_AND_REPLICATION_PORT]
ID: N/A::

Severity: ERROR
+
Message: The server administration port and the replication port have the same value in host %s.  You provided %s for both.

[#log-ref-log-ref-ERR_REPLICATION_PURGE_HISTORICAL]
ID: N/A::

Severity: ERROR
+
Message: An error occurred executing the purge historical.  Details: %s.%nYou can check the error logs of the local server for more information.

[#log-ref-log-ref-ERR_REPLICATION_PURGE_SUFFIXES_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_READING]
ID: N/A::

Severity: ERROR
+
Message: Error reading registration information.  Details: %s.

[#log-ref-log-ref-ERR_REPLICATION_READING_REGISTERED_SERVERS]
ID: N/A::

Severity: ERROR
+
Message: The following errors were encountered reading the configuration of the existing servers:
%s
...
[#log-ref-log-ref-ERR_REPLICATION_READING_REGISTERED_SERVERS_CONFIRM_UPDATE]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_SAME_REPLICATION]
ID: N/A::

Severity: ERROR
+
Message: You have provided the same replication port (%s) for two servers located on the same machine (%s).

[#log-ref-log-ref-ERR_REPLICATION_STATUS]
ID: N/A::

Severity: ERROR
+
Message: The '%s' subcommand is not compatible with the %s option.

[#log-ref-log-ref-ERR_REPLICATION_STATUS_READING_REGISTERED]
ID: N/A::

Severity: ERROR
+
Message: The displayed information might not be complete because the following errors were encountered reading the configuration of the existing servers:%n%s.

[#log-ref-log-ref-ERR_REPLICATION_UPDATING]
ID: N/A::

Severity: ERROR
+
Message: Error updating registration information.  Details: %s.

[#log-ref-log-ref-ERR_REPLICATION_USER]
ID: N/A::
...
[#log-ref-log-ref-ERR_REPLICATION_VALID_SUBCOMMAND_NOT]
ID: N/A::

Severity: ERROR
+
Message: Could not find a valid subcommand.  You must specify a subcommand when using the option %s.

[#log-ref-log-ref-ERR_SOURCE_DESTINATION_INITIALIZE_SAME_SERVER]
ID: N/A::

Severity: ERROR
+
Message: You have to provide two different servers as source and destination of the initialization.  You have provided twice the server %s:%s.

[#log-ref-log-ref-ERR_SUFFIXES_CANNOT_BE]
ID: N/A::

Severity: ERROR
+
Message: The following base DNs cannot be initialized because they are not replicated or they are not configured on both servers:%n%s.

[#log-ref-log-ref-ERR_UNEXPECTED_DURING_TASK_NO]
ID: N/A::

Severity: ERROR
+
Message: Unexpected error during the operation.  Task state: %s.  Check the error logs of %s for more information.

[#log-ref-log-ref-ERR_UNEXPECTED_DURING_TASK_WITH]
ID: N/A::

Severity: ERROR
+
Message: Unexpected error during the operation.  Last log details: %s.  Task state: %s.  Check the error logs of %s for more information.

[#log-ref-log-ref-ERR_UNINSTALL_ERROR_UPDATING_REMOTE]
ID: N/A::

Severity: ERROR
+
Message: This server is configured to replicate some of its base DNs.  There was an error retrieving the references to it in the replicated servers.  Note that to be able to remove remote references you must provide Global Administrator credentials using the %s and %s (or %s) options.%nContinuing uninstall as we are on force on error mode.%n%nThe error found was:%n%s.

[#log-ref-log-ref-ERR_UNINSTALL_ERROR_UPDATING_REMOTE_NO]
ID: N/A::
...
[#log-ref-log-ref-ERR_UNINSTALL_FORCE_REQUIRES_NO]
ID: N/A::

Severity: ERROR
+
Message: The %s option only can be used when %s has been specified.

[#log-ref-log-ref-ERR_UNINSTALL_LAUNCHER_GUI_LAUNCHED]
ID: N/A::

Severity: ERROR
+
Message: %n%nThe graphical Uninstall launch failed.%n%nLaunching command line uninstall...

[#log-ref-log-ref-ERR_UNINSTALL_LAUNCHER_GUI_LAUNCHED_FAILED]
ID: N/A::

Severity: ERROR
+
Message: %n%nThe graphical Uninstall launch failed.  Check file %s for more details.%n%nLaunching command line uninstall...

[#log-ref-log-ref-ERR_UNINSTALL_NOT_UPDATE_REMOTE]
ID: N/A::

Severity: ERROR
+
Message: This server is configured to replicate some of its base DNs.  There was an error retrieving the references to it in the replicated servers.%nDo you want to continue?.

[#log-ref-log-ref-ERR_UNINSTALL_READING_REGISTERED_SERVERS_CONFIRM_UPDATE]
ID: N/A::

Severity: ERROR
+
Message: The following errors were encountered reading the configuration of the existing servers:%n%s%nDo you want the uninstaller to try to remove the references to this server in a best-effort mode?.

[#log-ref-log-ref-ERR_VERSION_IN_REMOTE_SERVER_NOT]
ID: N/A::

Severity: ERROR
+
Message: Could not find version information in the remote server.  The remote LDAP server does not seem to be manageable remotely by the control panel.
...
[#log-ref-log-ref-ERR_COMPSCHEMA_CANNOT_MIGRATE_619]
ID: 619::

Severity: ERROR
+
Message: The compressed schema definitions of backend '%s' could not be migrated from the shared tree '%s' to '%s': %s. The backend cannot be opened, because its entries were encoded against the definitions that were not migrated and would decode as the wrong attributes.

[#log-ref-log-ref-ERR_BACKEND_CANNOT_DEREGISTER_BASEDN_620]
ID: 620::

Severity: ERROR
+
Message: An error occurred while attempting to deregister base DN %s from the Directory Server:  %s.

[#log-ref-log-ref-ERR_BACKEND_CANNOT_CHANGE_BASEDNS_621]
ID: 621::

Severity: ERROR
+
Message: The base DNs of backend %s could not be changed (to remove: %s, to add: %s):  %s. A storage engine which rolls the whole write back leaves the backend exactly as it was; on one which does not, the base DNs whose trees are gone have been given up. The base DNs being added are not being served, but the configuration which has been stored still names them, so the next time this backend is opened it opens them from that configuration, keeping whatever trees the failed change created for them and creating the ones it did not. A base DN being removed of which only some trees survived is given up with those trees still in the storage, where nothing names them afterwards; removing them means re-creating the backend.

[#log-ref-log-ref-ERR_BACKEND_CANNOT_LIST_TREES_AFTER_BASEDN_CHANGE_622]
ID: 622::

Severity: ERROR
+
Message: The base DN change of backend %s failed, and the trees which survived it could not be listed:  %s. No base DN has been given up on the strength of that, so this backend may still be serving one whose trees are gone, which answers every operation against it with a storage error.

[#log-ref-log-ref-ERR_BACKEND_BASEDN_NO_LONGER_HELD_623]
ID: 623::
...
[#log-ref-log-ref-ERR_CONFIG_INDEX_DELETE_FAILED_624]
ID: 624::

Severity: ERROR
+
Message: The index for attribute '%s' of backend base DN '%s' was removed from the configuration, but the trees holding its data could not be deleted: %s. Those trees may still hold the data of that index, in whole or in part, and no configuration names them any more, so nothing will delete them and nothing will keep them up to date. An index created again for that attribute while this backend is open discards those trees and starts empty, asking to be rebuilt as any index added to a backend holding entries does; one created while this backend is disabled adopts them at the next open and is considered trusted over their stale content, so it must be rebuilt before it is used.

[#log-ref-log-ref-ERR_CONFIG_VLV_INDEX_DELETE_FAILED_625]
ID: 625::
...
[#log-ref-log-ref-ERR_CONFIG_INDEX_CHANGE_FAILED_626]
ID: 626::

Severity: ERROR
+
Message: The configuration of the index for attribute '%s' of backend base DN '%s' could not be applied in full: %s. What this index holds and what its configuration declares may no longer agree, so this index must be rebuilt before it is used, after this backend has been disabled and enabled again so that every tree the stored configuration declares is named once more. The trees of the index types this change removed may still hold their data while no configuration names them any more, so nothing will delete them and nothing will keep them up to date; an index type declared again for that attribute while this backend is open discards those trees and starts empty, asking to be rebuilt, while one declared again while this backend is disabled adopts them at the next open and is considered trusted over their stale content, and must be rebuilt too.

[#log-ref-log-ref-ERR_CONFIG_BACKEND_DATA_CHANGE_FAILED_627]
ID: 627::

Severity: ERROR
+
Message: The compression, encoding and encryption settings of backend base DN '%s' could not be applied in full: %s. Its entries and its indexes may no longer be encoded under the same settings; disabling and enabling this backend builds both from the stored configuration again.

[#log-ref-log-ref-ERR_CONFIG_INDEX_ATTRIBUTE_ALREADY_INDEXED_629]
ID: 629::

Severity: ERROR
+
Message: Attribute %s of backend base DN '%s' is already indexed by %s. An attribute type is indexed once, whichever of its names or its OID the index is declared by, so change that index instead of adding another one for the same attribute.
...
[#log-ref-log-ref-ERR_CONFIG_CORE_SERVER_ERROR_RESULT_CODE_NOT_A_FAILURE_768]
ID: 768::

Severity: ERROR
+
Message: The value '%s' is not acceptable for attribute ds-cfg-server-error-result-code because result code '%s' does not report a failure. This server puts that code on the operations an internal error prevents it from processing, so a code which reports a success leaves a failed operation indistinguishable from one which succeeded: a replication domain would record a change it never applied as replayed, or publish an operation which failed to the whole topology.
...
[#log-ref-log-ref-ERR_COMPRESSEDSCHEMA_UNREADABLE_AD_TOKEN_757]
ID: 757::

Severity: ERROR
+
Message: Unable to decode the provided attribute because its attribute description token could not be read from the record: %s.

[#log-ref-log-ref-ERR_COMPRESSEDSCHEMA_UNREADABLE_OC_TOKEN_758]
ID: 758::

Severity: ERROR
+
Message: Unable to decode the provided object class set because its token could not be read from the record: %s.

[#log-ref-log-ref-ERR_CRYPTOMGR_SSL_CERT_NICKNAME_NOT_FOUND_759]
ID: 759::

Severity: ERROR
+
Message: The certificate nickname "%s" configured in the ssl-cert-nickname property of the crypto manager was not found in the trust store %s used for server to server communication, so the %s component cannot present that certificate to its peers. Where it is the only nickname configured, no certificate is presented at all and peers requiring client authentication, replication servers included, reject the connection. Import the key pair under that nickname into that trust store, or configure a nickname it holds.

[#log-ref-log-ref-ERR_COMPRESSEDSCHEMA_UNUSABLE_AD_TOKEN_760]
ID: 760::

Severity: ERROR
+
Message: The stored compressed schema definition of the attribute type '%s' has been skipped because the token %s it is stored under is not one a compressed schema hands out. Entries carrying that token will be reported as using an undefined attribute description token.

[#log-ref-log-ref-ERR_COMPRESSEDSCHEMA_UNUSABLE_OC_TOKEN_761]
ID: 761::

Severity: ERROR
+
Message: The stored compressed schema definition of the object classes %s has been skipped because the token %s it is stored under is not one a compressed schema hands out. Entries carrying that token will be reported as using an undefined object class token.

[#log-ref-log-ref-ERR_COMPRESSEDSCHEMA_NO_TOKEN_LEFT_762]
ID: 762::

Severity: ERROR
+
Message: The compressed schema cannot allocate a token for a new definition: the next one would be the id %s, and a definition is only ever loaded back under an id of at most %s. A token this high is only ever reached where a stored definition named an id no compressed schema hands out, so the storage holding it should be exported and imported again.

[#log-ref-log-ref-ERR_CRYPTOMGR_KEY_WRAPPING_TRANSFORMATION_UNSUPPORTED_766]
ID: 766::

Severity: ERROR
+
Message: This Java runtime does not provide the key wrapping transformation %s: %s. The key-wrapping-transformation property of the crypto manager must name a transformation which the runtime supports.
...
[#log-ref-log-ref-ERR_LOGGER_ERROR_ROTATING_FILE_34]
ID: 34::

Severity: ERROR
+
Message: Error occurred while rotating log file %s to %s. The current log file will be kept and appended to, and the rotation will be retried on the next interval. Any further rotation errors will be ignored until a rotation succeeds.
...
[#log-ref-log-ref-ERR_PLUGIN_REFERENT_CANNOT_REPLACE_LOGFILE_130]
ID: 130::

Severity: ERROR
+
Message: The Referential Integrity plugin update log file %s could not be deleted and created again after its records were processed. Those records will be processed again the next time the log file is read.
...
[#log-ref-log-ref-ERR_CANNOT_DECODE_CONTROL_VALUE_1508]
ID: 1508::
...
[#log-ref-log-ref-ERR_JMX_CONNHANDLER_CANNOT_START_RMI_CONNECTOR_1537]
ID: 1537::

Severity: ERROR
+
Message: The JMX connection handler defined in configuration entry %s was unable to start the JMX RMI connector on port %d: %s.

[#log-ref-log-ref-ERR_LDAP_FILTER_DECODE_MAX_NESTING_DEPTH_1538]
ID: 1538::

Severity: ERROR
+
Message: Cannot decode the provided ASN.1 element as an LDAP search filter because it is nested more than %d levels deep, which exceeds the maximum allowed filter nesting depth.

[#log-ref-log-ref-ERR_HTTP_ERROR_WHILE_PROCESSING_REQUEST_1539]
ID: 1539::

Severity: ERROR
+
Message: An error occurred while processing the request %s: %s.

[#log-ref-log-ref-ERR_CONNHANDLER_TIMEOUT_WAITING_FOR_LISTENER_1540]
ID: 1540::

Severity: ERROR
+
Message: The %s did not attempt to open its listen port within %d seconds. The Directory Server will stop waiting for it and continue, but that connection handler may never accept connections.
...
[#log-ref-log-ref-ERR_ADS_ADMINISTRATOR]
ID: N/A::

Severity: ERROR
+
Message: The following administrators are defined in server %s but not in server %s:%n%s%nThe merge can only be performed if these administrators are defined in server %s.

[#log-ref-log-ref-ERR_CANNOT_CONNECT_TO_LOCAL]
ID: N/A::

Severity: ERROR
+
Message: You do not have enough access rights to read the configuration in the server. %nProvide credentials with enough rights. Details: %s.

[#log-ref-log-ref-ERR_COULD_NOT_FIND]
ID: N/A::

Severity: ERROR
+
Message: Could not find a remote peer to initialize the contents of local base DN: %s.

[#log-ref-log-ref-ERR_ERROR_CREATING_JAVA_HOME]
ID: N/A::

Severity: ERROR
+
Message: Error updating scripts with java properties. Error code: %d.

[#log-ref-log-ref-ERR_GENERIC_JAVA]
ID: N/A::

Severity: ERROR
+
Message: Could not use the arguments '%s' using the running Java virtual machine. Check that the Java virtual machine supports this argument.

[#log-ref-log-ref-ERR_INITIAL_MEMORY]
ID: N/A::

Severity: ERROR
+
Message: The initial memory value must be a positive integer.

[#log-ref-log-ref-ERR_INITIAL_MEMORY_VALUE]
ID: N/A::

Severity: ERROR
+
Message: Could not use the provided initial memory value. Check that the running Java virtual machine supports the %s argument and that there is enough memory in the machine to use the provided value.

[#log-ref-log-ref-ERR_INSTALL_ADS]
ID: N/A::

Severity: ERROR
+
Message: An error occurred while provisioning the trust store %s, used for server to server communication.%nThe error is: %s.

[#log-ref-log-ref-ERR_INSTALL_ADS_TRUSTSTORE]
ID: N/A::

Severity: ERROR
+
Message: The trust store %s, used for server to server communication, already exists and is left as it is.

[#log-ref-log-ref-ERR_INSTALL_ADS_TRUSTSTORE_CA_CERT_FILE]
ID: N/A::

Severity: ERROR
+
Message: The certificate file %s holds no certificate.

[#log-ref-log-ref-ERR_INSTALL_ADS_TRUSTSTORE_NO_KEY]
ID: N/A::

Severity: ERROR
+
Message: The key store %s holds no key pair, that is no private key with its certificate, under the alias %s.

[#log-ref-log-ref-ERR_INSTALL_ADS_TRUSTSTORE_NO_TRUST]
ID: N/A::

Severity: ERROR
+
Message: The key store %s holds no issuing certificate for the key pair or pairs %s: the certificate chain stops at the certificate itself.  A server trusts its peers on the replication port through the certificate authorities held in its trust store, and the chain of a key pair is not one of them, so this server would trust no peer and could join no topology.  Use a key store which holds the whole certificate chain, or name the certificates to trust with the --replicationCaCertFile argument.

[#log-ref-log-ref-ERR_INSTALL_ADS_TRUSTSTORE_RESERVED]
ID: N/A::

Severity: ERROR
+
Message: The certificate nickname %s cannot be presented on the replication port: the trust store used for server to server communication reserves the alias %s for the instance key the server generates when it first starts, and the aliases starting with %s for the certificates it trusts.  Store the key pair under another alias.

[#log-ref-log-ref-ERR_MAX_MEMORY]
ID: N/A::

Severity: ERROR
+
Message: The maximum memory value must be a positive integer.

[#log-ref-log-ref-ERR_MAX_MEMORY_BIGGER_THAN_INITIAL]
ID: N/A::

Severity: ERROR
+
Message: The maximum memory value must be higher than the initial memory value.

[#log-ref-log-ref-ERR_MAX_MEMORY_VALUE]
ID: N/A::

Severity: ERROR
+
Message: Could not use the provided maximum memory value. Check that the running Java virtual machine supports the %s argument and that there is enough memory in the machine to use the provided value.

[#log-ref-log-ref-ERR_MEMORY_32_BIT]
ID: N/A::

Severity: ERROR
+
Message: Note that 32-bit Java virtual machines do not support memory values higher than 2 gigabytes.

[#log-ref-log-ref-ERR_MEMORY_AND_OTHER_ARGUMENTS_NOT]
ID: N/A::

Severity: ERROR
+
Message: The provided memory arguments and the 'Other Java Arguments' were checked successfully separately. However there was an error running them simultaneously. Check that the provided arguments are compatible with the memory values.

[#log-ref-log-ref-ERR_MEMORY_VALUE]
ID: N/A::

Severity: ERROR
+
Message: Could not use the provided memory values. Check that the running Java virtual machine supports the %s and %s arguments and that there is enough memory in the machine to use the provided values.
...
[#log-ref-log-ref-ERR_COULD_NOT_BIND_CHANGELOG_LISTENING_303]
ID: 303::

Severity: ERROR
+
Message: Another socket is listening on %s.

[#log-ref-log-ref-ERR_COULD_NOT_BIND_CHANGELOG_NOT_ACCEPTING_304]
ID: 304::

Severity: ERROR
+
Message: Nothing accepted a connection on %s : the port is held either by a socket bound to another address, or by a socket which does not accept connections.

[#log-ref-log-ref-ERR_COULD_NOT_BIND_CHANGELOG_PORT_FREE_305]
ID: 305::

Severity: ERROR
+
Message: Nothing holds %s anymore : the port was released after the last attempt to bind it.

[#log-ref-log-ref-ERR_REPLAY_SKIPPING_CHANGE_308]
ID: 308::

Severity: ERROR
+
Message: Could not replay change %s in domain "%s": its replay has been failing for %d ms over %d deliveries, each attempted several times in place. The change is being skipped: this replica now diverges from the rest of the topology and must be reinitialized. Raise the replay-give-up-delay property of this domain to give a change longer before it is given up on.

[#log-ref-log-ref-ERR_ERROR_REPLAYING_CHANGE_315]
ID: 315::

Severity: ERROR
+
Message: An Error was thrown while replaying change %s in domain "%s": %s. The change has not been recorded as replayed and is given back to the replication server, which still owns it and sends it again.

[#log-ref-log-ref-ERR_ACK_NOT_PUBLISHED_316]
ID: 316::

Severity: ERROR
+
Message: Could not complete the delivery of change %s in domain "%s" once its replay was done - that is where the delivery is accounted for and, for an assured write in safe-read mode, acknowledged: %s. Whether the change was applied is what its replay decided, and it is unaffected. A server which is waiting for that acknowledgement waits out its assured timeout instead.

[#log-ref-log-ref-ERR_REPLAY_GIVE_BACK_FAILED_317]
ID: 317::

Severity: ERROR
+
Message: Could not give change %s of domain "%s" back to the replication server after the replay which owned it was unwound: %s. The change has been released without its failure being counted, and a restart of the session is asked for so that the change is delivered again.

[#log-ref-log-ref-ERR_REPLAY_ENTRYUUID_SEARCH_FAILED_322]
ID: 322::

Severity: ERROR
+
Message: Could not read the data to check change %s for a conflict in domain "%s": the search of the entry with entryUUID %s did not run (%s). The change is not applied on what a search which read nothing seemed to say about the data, and is not recorded as replayed.

[#log-ref-log-ref-ERR_CHECKPOINTING_STATE_FAILED_323]
ID: 323::

Severity: ERROR
+
Message: Could not write the replication state of domain "%s" : %s. The state stays unsaved: the next checkpoint writes it again, and a domain which was stopping comes back with the last state it did write and replays the changes since.

[#log-ref-log-ref-ERR_STATE_CHECKPOINTER_NOT_STOPPED_324]
ID: 324::

Severity: ERROR
+
Message: The state checkpointer of domain "%s" has not stopped within %d ms : the shutdown of the domain goes on without it.

[#log-ref-log-ref-ERR_REPLAY_SESSION_RESTART_FAILED_325]
ID: 325::

Severity: ERROR
+
Message: Could not restart the replication session of domain "%s" for the changes which could not be replayed: %s. The session is left stopped and is started again a moment later; the changes it is being restarted for are not recorded as replayed and are still owned by the replication server.

[#log-ref-log-ref-ERR_REPLICATION_DOMAIN_CONFIG_CHANGE_FAILED_326]
ID: 326::

Severity: ERROR
+
Message: Could not apply a configuration change to the replication domain on "%s": %s.

[#log-ref-log-ref-ERR_INIT_SESSION_STOPPED_DURING_IMPORT_329]
ID: 329::

Severity: ERROR
+
Message: Domain %s (server id: %s) : the session to the replication server was stopped before the initialization from server %s completed. The entries which had arrived are imported, and the generation id of the data is computed over them rather than taken from the exporter.

[#log-ref-log-ref-ERR_INIT_REJECTED_SESSION_STOPPING_330]
ID: 330::

Severity: ERROR
+
Message: The total update of domain "%s" was refused by directory server %d: its session to the replication server is being stopped, and the entries would have been streamed over that session. Ask for the total update again once the session is back.
...
--
[#log-ref-log-ref-ERR_ADMINISTRATOR_PWD_DO_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_CANNOT_BIND_TO]
ID: N/A::
...
[#log-ref-log-ref-ERR_CANNOT_BIND_TO_PRIVILEGED]
ID: N/A::
...
[#log-ref-log-ref-ERR_CONFIGDS_CANNOT_UPDATE_CRYPTO_MANAGER_CERT]
ID: N/A::

Severity: ERROR
+
Message: An error occurred while attempting to update the nickname of the certificate that the crypto manager should present for server to server communication: %s.

[#log-ref-log-ref-ERR_CONFIRMATION_TRIES_LIMIT]
ID: N/A::
...
[#log-ref-log-ref-ERR_ERROR_BIND_PASSWORD]
ID: N/A::
...
[#log-ref-log-ref-ERR_ERROR_CANNOT_READ_CONNECTION]
ID: N/A::
...
[#log-ref-log-ref-ERR_ERROR_INCOMPATIBLE_PROPERTY]
ID: N/A::
...
[#log-ref-log-ref-ERR_ERROR_NO_ADMIN]
ID: N/A::
...
[#log-ref-log-ref-ERR_FAILED_TO_CONNECT_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_FAILED_TO_CONNECT_WRONG]
ID: N/A::
...
[#log-ref-log-ref-ERR_INSTALLDS_REPLICATION_CA_CERT_FILE]
ID: N/A::

Severity: ERROR
+
Message: The certificate file %s does not exist or is not a file.

[#log-ref-log-ref-ERR_INSTALLDS_REPLICATION_KEYSTORE]
ID: N/A::

Severity: ERROR
+
Message: The --%s argument requires an existing key store: use it together with --%s, --%s, --%s or --%s.  The key pair presented on the replication port is copied out of that key store, so it can be neither a certificate generated by the installer nor a key held in a PKCS#11 token, whose private keys cannot be exported.

[#log-ref-log-ref-ERR_LDAP_CONN_BAD_HOST]
ID: N/A::
...
[#log-ref-log-ref-ERR_LDAP_CONN_PROMPT_SECURITY_INVALID_FILE]
ID: N/A::
...
[#log-ref-log-ref-ERR_RESOLVE_KEYSTORE]
ID: N/A::

Severity: ERROR
+
Message: Unable to resolve keystore aliases: %s.

[#log-ref-log-ref-ERR_SIMPLE_BIND_NOT]
ID: N/A::
...
[#log-ref-log-ref-ERR_TRUSTING]
ID: N/A::

Severity: ERROR
+
Message: Unable to trust the certificate because: %s.

[#log-ref-log-ref-ERR_TRUSTING_CERTIFICATE]
ID: N/A::

Severity: ERROR
+
Message: Unable to trust the certificate permanently, certificate will be trusted only for this session. Error details: %s.

[#log-ref-log-ref-ERR_UPGRADE_READING_CONF]
ID: N/A::
...
[#log-ref-log-ref-ERR_CERTMGR_NO_KEY_ENTRY_344]
ID: 344::

Severity: ERROR
+
Message: There is no key entry, that is a private key and its certificate chain, under the alias %s in the key store %s.

[#log-ref-log-ref-ERR_CERTMGR_IMPORT_KEY_ENTRY_345]
ID: 345::

Severity: ERROR
+
Message: The key entry with alias %s could not be imported because of the following reason: %s.

[#log-ref-log-ref-ERR_CERTMGR_KEY_PASSWORD_DIFFERS_346]
ID: 346::

Severity: ERROR
+
Message: The private key with alias %s in the key store %s is protected by a password other than the password of the key store. The server unlocks private keys with the key store password only, so protect the key with that password, for instance with keytool -keypasswd.
