...
Enabled by default: true
+
See  <<dsconfig-set-extended-operation-handler-prop-end-transaction-extended-operation-handler>> for the properties of this Extended Operation Handler type.
...
Enabled by default: true
+
See  <<dsconfig-set-extended-operation-handler-prop-start-transaction-extended-operation-handler>> for the properties of this Extended Operation Handler type.
...
[#dsconfig-set-extended-operation-handler-prop-end-transaction-extended-operation-handler]
== End Transaction Extended Operation Handler
...
[#dsconfig-set-extended-operation-handler-prop-start-transaction-extended-operation-handler]
== Start Transaction Extended Operation Handler
