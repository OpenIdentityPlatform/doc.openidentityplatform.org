...
+
See  <<dsconfig-set-identity-mapper-prop-exact-match-identity-mapper>> for the properties of this Identity Mapper type.
...
Enabled by default: true
+
See  <<dsconfig-set-identity-mapper-prop-regular-expression-identity-mapper>> for the properties of this Identity Mapper type.
====
