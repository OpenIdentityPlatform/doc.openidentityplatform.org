...
+
See  <<dsconfig-set-entry-cache-prop-fifo-entry-cache>> for the properties of this Entry Cache type.
...
Enabled by default: true
+
See  <<dsconfig-set-entry-cache-prop-soft-reference-entry-cache>> for the properties of this Entry Cache type.
====
