...
+
See  <<dsconfig-get-connection-handler-prop-http-connection-handler>> for the properties of this Connection Handler type.
...
Enabled by default: true
+
See  <<dsconfig-get-connection-handler-prop-jmx-connection-handler>> for the properties of this Connection Handler type.
...
Enabled by default: true
+
See  <<dsconfig-get-connection-handler-prop-ldap-connection-handler>> for the properties of this Connection Handler type.
...
Enabled by default: true
+
See  <<dsconfig-get-connection-handler-prop-ldif-connection-handler>> for the properties of this Connection Handler type.
...
Enabled by default: true
+
See  <<dsconfig-get-connection-handler-prop-snmp-connection-handler>> for the properties of this Connection Handler type.
====
