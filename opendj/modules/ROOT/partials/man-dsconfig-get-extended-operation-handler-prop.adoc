...
Enabled by default: true
+
See  <<dsconfig-get-extended-operation-handler-prop-end-transaction-extended-operation-handler>> for the properties of this Extended Operation Handler type.
...
Enabled by default: true
+
See  <<dsconfig-get-extended-operation-handler-prop-start-transaction-extended-operation-handler>> for the properties of this Extended Operation Handler type.
...
[#dsconfig-get-extended-operation-handler-prop-end-transaction-extended-operation-handler]
== End Transaction Extended Operation Handler
...
[#dsconfig-get-extended-operation-handler-prop-start-transaction-extended-operation-handler]
== Start Transaction Extended Operation Handler
