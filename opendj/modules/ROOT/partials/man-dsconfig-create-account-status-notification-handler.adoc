...
+
See  <<dsconfig-create-account-status-notification-handler-error-log-account-status-notification-handler>> for the properties of this Account Status Notification Handler type.
...
Enabled by default: true
+
See  <<dsconfig-create-account-status-notification-handler-smtp-account-status-notification-handler>> for the properties of this Account Status Notification Handler type.
====
