...
+
See  <<dsconfig-list-identity-mappers-exact-match-identity-mapper>> for the properties of this Identity Mapper type.
...
Enabled by default: true
+
See  <<dsconfig-list-identity-mappers-regular-expression-identity-mapper>> for the properties of this Identity Mapper type.
====
